...
def generate_snake(snake_start, snake_position, apple_position, button_direction, score):
    ...
    elif snake_start == [200,250]:
	return 1
    elif snake_start == [100,350]:
	return 1
    elif snake_start == [150,100]:
	return 1
    elif snake_start == [350,100]:
	return 1
    else:
        snake_position.insert(0, list(snake_start))
        snake_position.pop()
...
def play_game(snake_start, snake_position, apple_position, button_direction, score, display, clock):
	...
	pygame.display.update()
        pygame.draw.rect(display, [0,0,0], [200, 250,10,10])
        pygame.draw.rect(display, [0,0,0], [100, 350,10,10])
        pygame.draw.rect(display, [0,0,0], [150, 100,10,10])
        pygame.draw.rect(display, [0,0,0], [350, 100,10,10])
